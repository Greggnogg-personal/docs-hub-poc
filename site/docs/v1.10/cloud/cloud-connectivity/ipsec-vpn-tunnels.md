...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: IPSEC VPN Tunnels (Single Region)'
lastUpdatedAt: 1758900000000
canonical: /docs/cloud/cloud-connectivity/ipsec-vpn-tunnels/
---
...
![IPSEC VPN](/cloud-images/cloud-connectivity/ipsec-vpn.png)

## Redundancy options
With the IPSEC VPN solution there are options for Single, Active/Passive and Active/Active Firewalls:

![IPSEC redundancy options](/cloud-images/cloud-connectivity/ipsec-redundancy-options.png)
