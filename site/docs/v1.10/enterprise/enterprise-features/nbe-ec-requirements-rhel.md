...
tags:
  ...
  - enterprise
  - netbox
title: NetBox Enterprise Requirements for Red Hat Enterprise Linux (RHEL) (v1.10)
source: localdocs
lastUpdatedAt: 1758900000000
canonical: /docs/v1.10/enterprise/enterprise-features/nbe-ec-requirements-rhel/
---
...
### Set SELinux to Permissive mode (can be enforced later)
