...
complexity: advanced
title: Advanced Tools and Troubleshooting (v1.10)
source: localdocs
lastUpdatedAt: 1769032343000
canonical: /docs/v1.10/enterprise/enterprise-features/nbe-troubleshooting/
---
...
## Accessing Your Cluster from the Command Line \{#accessing-your-cluster\}
...
[Access your cluster](#accessing-your-cluster) from the shell.  If you haven't [installed the `support-bundle` package](#applications), do so now.
...
![Debug Logging Enabled](/enterprise-images/netbox-enterprise/netbox-enterprise-debug-logging-example.png)
