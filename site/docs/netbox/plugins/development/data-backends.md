...
tags:
  ...
  - installation
  - netbox
canonical: /docs/netbox/plugins/development/data-backends/
---
# Data Backends
...
A context manager which performs the following: 1.
Handles all setup and synchronization 2.
Yields the local path at which data has been replicated 3.
