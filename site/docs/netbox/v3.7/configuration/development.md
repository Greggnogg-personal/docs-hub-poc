...
canonical: /docs/v3.7/netbox/configuration/development/
---
...
clients which access NetBox from a recognized [internal IP address](../configuration/system.md#internal_ips) will see debugging tools in the user
interface.
