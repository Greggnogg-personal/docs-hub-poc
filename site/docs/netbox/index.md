...
tags:
  ...
  - ipam
  - netbox
canonical: /docs/netbox/index/
---
<div style={{height: '100px', marginBottom: '3em', background: 'none'}}>![NetBox](netbox_logo_light.svg#only-light "NetBox logo")</div>
<div style={{height: '100px', marginBottom: '3em', background: 'none'}}>![NetBox](netbox_logo_dark.svg#only-dark "NetBox logo")</div>
