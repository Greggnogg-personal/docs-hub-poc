...
canonical: /docs/integrations/tool-integrations/v1.2.6/servicenow/snow-faq/
---
...
**Configuration**: Set these parameters manually in the Parameters table.
...
3. **Check Synchronization Parameters**
   - Verify "Import NetBox [ObjectType]" parameters are set to `true`

4. **Check the Buffer Data Sources**
