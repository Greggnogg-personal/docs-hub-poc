...
canonical: /docs/integrations/tool-integrations/v1.3.4/servicenow/snow-technical-info/
---
...
1. **Classification**
- For data imported into ServiceNow, classification is accomplished through an interpretation of a device's role in NetBox
...
|(other) | Hardware | cmdb_ci_hardware |
 |
- Classification rules can be customized by editing the Devices Transformer in table **CMDB Integration Studio Application Data Source** (cmdb_inst_application_feed), or in IntegrationHub ETL
...
1. **Classification**
- For the moment, exported CIs are not classified in NetBox, meaning that ServiceNow classes will not translate to dynamic NetBox roles
- Instead, a generic role ID is defined in Application Parameters (see [User Guide, Application Parameters](snow-user-guide.md#application-parameters)) and all exported devices will be given that role
