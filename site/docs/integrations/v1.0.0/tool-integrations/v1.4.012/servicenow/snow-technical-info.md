...
canonical: /docs/integrations/tool-integrations/v1.4.012/servicenow/snow-technical-info/
---
...
|`x_990381_netbox_cl_netbox_locations_import` | Staging table for NetBox locations | Location name, description, site reference, parent location, hierarchy |
...
|`x_990381_netbox_cl_netbox_type` | Choice | Specifies whether location is a Region, Site, or Location in NetBox | Values: 'region', 'site', 'location' |
|`x_990381_netbox_cl_is_netbox_site` | Boolean | ~~States if a location record in ServiceNow must be interpreted as a Site in NetBox~~ | **DEPRECATED**: Use `netbox_type` instead |
|`x_990381_netbox_cl_is_netbox_region` | Boolean | ~~States if a location record in ServiceNow must be interpreted as a Region in NetBox~~ | **DEPRECATED**: Use `netbox_type` instead |
