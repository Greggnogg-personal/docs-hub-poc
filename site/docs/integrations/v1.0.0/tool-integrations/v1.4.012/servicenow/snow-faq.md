...
canonical: /docs/integrations/tool-integrations/v1.4.012/servicenow/snow-faq/
---
...
2. **Tables Created**: Check that new tables are present, for example:
   ...
   - `x_990381_netbox_cl_netbox_locations_import` (v1.4.0+)
...
- `x_990381_netbox_cl_netbox_locations_import` - NetBox locations staging (v1.4.0+)
