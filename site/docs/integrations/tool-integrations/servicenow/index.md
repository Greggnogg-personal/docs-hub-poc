---
title: ServiceNow NetBox CMDB Integration
description: >-
  Bidirectional synchronization between ServiceNow CMDB and NetBox for
...
canonical: /docs/integrations/tool-integrations/servicenow/index/
---
...
|----------|-------------|-----------------|
| **[Release Notes](release-notes.md)** | Release features and bug fixes |  End Users, System Administrators |
| **[Known Issues](known-issues.md)** | Known issues, workarounds, and resolution status | All Users |
| **[Installation and Setup](snow-installation.md)** | Step-by-step installation guide, system requirements, and initial configuration | ServiceNow Administrators, Integration Specialists |
| **[Upgrading](snow-upgrading.md)** | Upgrade procedures and version migration instructions | ServiceNow Administrators |
| **[User Guide](snow-user-guide.md)** | Complete user guide including configuration, data synchronization, use cases, and best practices | End Users, System Administrators, Integration Specialists |
| **[FAQ and Troubleshooting](snow-faq.md)** | Frequently asked questions and troubleshooting guidance | All Users |
| **[Technical Information](snow-technical-info.md)** | Technical details, table schemas, API information, and logging | Developers, Technical Specialists |
