...
versions:
  netbox_cloud: v1.10
status: current
lastUpdatedAt: 1762447299000
canonical: /docs/cloud/console-administration/okta-sso-setup/
...
Within the Okta administration dashboard, navigate to Applications > Applications, and click the "Create App Integration" button. Select "OIDC" as the sign-in method, and "Web application" for the application type.
    ...
    ![Create an app registration](/cloud-images/okta-sso/okta_create_app_registration.png)
    ...
    ![Web app integration](/cloud-images/okta-sso/okta_web_app_integration.png)
    ...
    ![Okta integration parameters](/cloud-images/okta-sso/okta_integration_parameters.png)
...
![NetBox Okta login form](/cloud-images/okta-sso/netbox_okta_login.png)
...
![Okta login portal](/cloud-images/okta-sso/okta_login_portal.png)
