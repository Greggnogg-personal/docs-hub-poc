...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: NetBox Cloud SAML Configuration Guide'
description: >-
  Configure SAML-based Single Sign-On (SSO) for NetBox Cloud. Set up your
  Identity Provider, configure entity IDs, assertion URLs, and enable secure
  authentication for your users.
lastUpdatedAt: 1762446654000
canonical: /docs/cloud/console-administration/saml-sso-setup/
---
