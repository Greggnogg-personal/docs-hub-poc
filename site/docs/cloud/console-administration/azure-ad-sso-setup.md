...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: Microsoft Entra ID Setup (formerly Azure Active Directory)'
lastUpdatedAt: 1756325328000
canonical: /docs/cloud/console-administration/azure-ad-sso-setup/
---
...
Under the Microsoft Entra ID dashboard, navigate to **Add** > **App registration**.
    ...
    ![Add an app registration](/cloud-images/azure-sso/azure_ad_add_app_registration.png)
    ...
    ![Add an app registration](/cloud-images/azure-sso/azure_ad_app_registration.png)

    Once finished, make note of the application (client) ID; this will be used when configuring NetBox Cloud.

    ![Completed app registration](/cloud-images/azure-sso/azure_ad_app_registration_created.png)
...
3. Create a secret
    ...
    ![Add a client secret](/cloud-images/azure-sso/azure_ad_add_client_secret.png)

    You can optionally specify a description and select a lifetime for the secret.

    ![Client secret parameters](/cloud-images/azure-sso/azure_ad_client_secret.png)

    Once finished, make note of the secret value (not the secret ID); this will be used when configuring NetBox Cloud.

    ![Client secret parameters](/cloud-images/azure-sso/azure_ad_client_secret_created.png)
...
![NetBox Entra ID login form](/cloud-images/azure-sso/netbox_azure_ad_login.png)
...
![Microsoft authentication portal](/cloud-images/azure-sso/azure_ad_login_portal.png)
