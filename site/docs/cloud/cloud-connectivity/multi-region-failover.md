...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: AWS Multi Region Failover'
description: >-
  Configure multi-region deployment for NetBox Cloud Premium Tier with automatic
  failover for high availability. Learn about architecture, replication,
  disaster recovery procedures, and monitoring strategies.
lastUpdatedAt: 1762446654000
canonical: /docs/cloud/cloud-connectivity/multi-region-failover/
---
