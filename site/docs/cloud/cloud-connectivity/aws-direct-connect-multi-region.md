...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: AWS Direct Connect (Multi-Region)'
internal_only: true
lastUpdatedAt: 1756227741000
canonical: /docs/cloud/cloud-connectivity/aws-direct-connect-multi-region/
---
...
![AWS Direct Connect Multi-Region Failover](/cloud-images/cloud-connectivity/aws-direct-connect-multi-region-failover.png)
