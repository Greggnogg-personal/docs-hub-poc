...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: Console Administration'
lastUpdatedAt: 1753958602000
canonical: /docs/cloud/console-administration/console-administration/
---
...
2. Click on **Settings** and then click on **Administrators**:
    ...
    ![console settings admin](/cloud-images/console/console-settings-admin.png)

3. Enter the email address for the administrator you wish to invite and then click **Invite**:

    ![console email invite](/cloud-images/console/console-email-invite.png)
