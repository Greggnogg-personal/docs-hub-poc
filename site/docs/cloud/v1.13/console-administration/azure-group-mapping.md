...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: Group Mapping For Microsoft Entra ID Single Sign-On (SSO)'
lastUpdatedAt: 1769027798000
canonical: /docs/cloud/console-administration/azure-group-mapping/
---
...
:::info
This feature is only available in Pro/Premium tiers.
...
![Entra ID Group Object ID](/cloud-images/azure-sso/azure_group_sync_1.png)
...
![NetBox Group Configuration](/cloud-images/azure-sso/azure_group_sync_2.png)

![NetBox Group Permissions](/cloud-images/azure-sso/azure_group_sync_3.png)
