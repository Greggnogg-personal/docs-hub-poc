...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: AWS Direct Connect (Single Region)'
lastUpdatedAt: 1769027798000
canonical: /docs/cloud/cloud-connectivity/aws-direct-connect/
---
...
![AWS Direct Connect](/cloud-images/cloud-connectivity/aws-direct-connect.png)
