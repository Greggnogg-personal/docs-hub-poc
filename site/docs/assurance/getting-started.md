...
related_docs:
  - index.md
  - using-the-ui.md
  - /docs/discovery/getting-started
  - /docs/diode/
external_links:
  - 'https://netdev.chat/'
title: 'NetBox Assurance: Getting Started with NetBox Assurance'
lastUpdatedAt: 1764944343000
canonical: /docs/assurance/getting-started/
---
...
- **[NetBox Discovery](/docs/discovery/getting-started)** - Recommended for automated network discovery
- **Controller integrations** - For centralized network management platforms
- **Custom integrations** - Using the [Diode SDK](/docs/diode/)
...
1. Follow the [NetBox Discovery setup guide](/docs/discovery/getting-started)
...
1. Review the [Diode integration documentation](/docs/diode/)
...
2. **[Expand NetBox Discovery](/docs/discovery/getting-started)** - Add more network segments and device types
3. **[Explore Diode Integration](/docs/diode/)** - Build custom integrations for specialized needs
...
- **NetBox Discovery**: Complete [setup and configuration guide](/docs/discovery/getting-started)
- **Diode Integration**: Advanced [API and SDK documentation](/docs/diode/)
