...
title: 'NetBox Assurance: NetBox Assurance'
lastUpdatedAt: 1764944343000
canonical: /docs/assurance/index/
---
...
- **[NetBox Discovery Agents](/docs/discovery/)** - Automated network and device discovery
- **Controller Integrations** - VMware vCenter, Juniper Mist, Cisco Catalyst Center, etc.
- **[Diode API](/docs/diode/)** - Custom integrations using Python or Go SDKs
...
NetBox Assurance and [NetBox Discovery](/docs/discovery/) work together to provide complete network visibility and control:
...
NetBox Assurance is not available for NetBox Community Edition. However, the underlying [Diode project](/docs/diode/) provides data ingestion capabilities that work with NetBox Discovery agents.
...
3. **[NetBox Discovery](/docs/discovery/getting-started)** - Set up automated network discovery for data ingestion

## Support and Resources

- **Community Support**: Connect with the community on [Slack](https://netdev.chat/) in the `#netbox` channel
- **Integration Guides**: Learn about [Diode Integration](/docs/diode/) for advanced API and SDK usage
