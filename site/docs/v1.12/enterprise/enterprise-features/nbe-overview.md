...
tags:
  ...
  - kubernetes
  - netbox
title: NetBox Enterprise (v1.12)
description: >-
  NetBox Enterprise provides a simplified installation and upgrade process for
  self-hosted NetBox deployments. Includes advanced features, integrations, and
  professional support not available in the community edition.
lastUpdatedAt: 1764177275000
canonical: /docs/v1.12/enterprise/enterprise-features/nbe-overview/
---
