...
title: Microsoft Entra ID Setup (formerly Azure Active Directory) (v1.10)
source: localdocs
lastUpdatedAt: 1758900000000
canonical: /docs/v1.10/enterprise/enterprise-features/nbe-azure-sso/
---
...
Under the Microsoft Entra ID dashboard, navigate to **Add** > **App registration**.
    ...
    ![Add an app registration](/enterprise-images/azure-sso/azure_ad_add_app_registration.png)
    ...
    ![Add an app registration](/enterprise-images/azure-sso/azure_ad_app_registration.png)

    Once finished, make note of the application (client) ID; this will be used when configuring NetBox Enterprise instance.

    ![Completed app registration](/enterprise-images/azure-sso/azure_ad_app_registration_created.png)
...
3. Create a secret
    ...
    ![Add a client secret](/enterprise-images/azure-sso/azure_ad_add_client_secret.png)

    You can optionally specify a description and select a lifetime for the secret.

    ![Client secret parameters](/enterprise-images/azure-sso/azure_ad_client_secret.png)
    ...
    ![Client secret parameters](/enterprise-images/azure-sso/azure_ad_client_secret_created.png)
...
![advanced settings](/enterprise-images/netbox-enterprise/advanced_settings.png)
...
![NetBox Entra ID login form](/enterprise-images/azure-sso/netbox_azure_ad_login.png)
