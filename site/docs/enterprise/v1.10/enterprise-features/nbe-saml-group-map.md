...
tags:
  ...
  - enterprise
  - netbox
title: Configuring SAML Group Mapping in NetBox Enterprise (v1.10)
source: localdocs
lastUpdatedAt: 1758900000000
canonical: /docs/v1.10/enterprise/enterprise-features/nbe-saml-group-map/
---
...
![SAML Settings](/enterprise-images/netbox-enterprise/SAML/netbox-enterprise-saml-idp-groups.png)
