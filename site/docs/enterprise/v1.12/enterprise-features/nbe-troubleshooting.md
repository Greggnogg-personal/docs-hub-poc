...
complexity: advanced
title: Advanced Tools and Troubleshooting (v1.12)
...
canonical: /docs/v1.12/enterprise/enterprise-features/nbe-troubleshooting/
---
...
### Command-Line Access \{#accessing-your-cluster\}
...
1. [Access your cluster](#accessing-your-cluster) from the shell
