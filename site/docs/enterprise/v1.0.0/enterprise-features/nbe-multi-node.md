...
complexity: advanced
title: 'NetBox Enterprise: NetBox Enterprise Multi-Node Deployment'
source: localdocs
lastUpdatedAt: 1769032343000
canonical: /docs/enterprise/enterprise-features/nbe-multi-node/
---
...
3. Click **Add node** button to generate join commands
   ...
   ![Add a Node](../../../static/enterprise-images/netbox-enterprise/multi-node-add-dialog.jpg)
...
4. On each new node, run the provided commands:
   ...
   ![Join Node Terminal Output](../../../static/enterprise-images/netbox-enterprise/multi-node-join-terminal.jpg)

5. Verify nodes have joined successfully in the **Cluster Management** tab

   ![Cluster Management Nodes View](../../../static/enterprise-images/netbox-enterprise/multi-node-cluster-management.jpg)
