...
related_docs:
  - getting-started.md
  - /docs/assurance/netbox-assurance/
  - ../../diode/index.md
external_links:
  - 'https://github.com/netboxlabs/orb-agent'
  - 'https://netdev.chat/'
title: 'NetBox Discovery: NetBox Discovery'
lastUpdatedAt: 1764944343000
canonical: /docs/discovery/index/
---
...
- **Diode Documentation**: For advanced Diode configuration and SDK usage, see the [Diode documentation](/docs/diode/)
