...
description: Change request model for NetBox Change Management workflow
tags:
  - administration
  - automation
  - cloud
...
The [policy](./policy) which must be met for the change request to be approved.
