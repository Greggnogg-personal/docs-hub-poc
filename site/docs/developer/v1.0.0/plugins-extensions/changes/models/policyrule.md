---
title: Policy Rules
description: Policy rules for NetBox Change Management policies
tags:
  - administration
  - authentication
  - cloud
...
canonical: /docs/developer/plugins-extensions/changes/models/policyrule/
---
# Policy Rules

Each [policy](./policy) contains one or more rules which assert certain conditions that must be met for the policy to be met. For example, you might define a policy that requires the approval of two engineers and one manager.
