...
versions:
  netbox_cloud: v1.10
status: current
title: 'NetBox Cloud: Upgrading NetBox Cloud'
lastUpdatedAt: 1769027798000
canonical: /docs/cloud/console-administration/upgrading-nbc/
---
...
1. In the NetBox Labs [Console](https://console.netboxlabs.com/dashboard/), click on the three dots in the top right corner of the instance you wish to upgrade and click **Upgrade**. Note the current NetBox version in this example is 4.1.7.
    ...
    ![Manage Instance](/cloud-images/upgrades/upgrades_manage_1.png)
...
2. The **Safe Upgrade tool** will present you with the **potential** and **recommended** versions you can upgrade to.
    ...
    ![Upgrade Options](/cloud-images/upgrades/upgrades_upgrade_options_3.png)
    ...
    ![Incompatible Plugin Warning](/cloud-images/upgrades/upgrades_incompatible_plugin.png)
...
4. Click on **UPGRADE VERSION**.
    ...
    ![Click Upgrade Button](/cloud-images/upgrades/upgrades_upgrade_4.png)

5. Click on **Continue** if you are sure you want to go ahead with the upgrade.

    ![Upgrade Confirmation Warning](/cloud-images/upgrades/upgrades_warning_5.png)

6. You will then see a dialog box confirming the upgrade is in progress.

    ![Upgrade in Progress](/cloud-images/upgrades/upgrades_progress_6.png)

7. A few seconds later, your NetBox Cloud upgrade will be complete. You will see the new version number.

    ![Upgrade Complete - New Version](/cloud-images/upgrades/upgrades_new_version_7.png)
